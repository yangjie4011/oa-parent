            ...
            <div class="bottom-main">
                        ...
                        <c:forEach var="item" items="${hiActinstList}" varStatus="status"> 
	                                          ...
	                                          <c:if test="${item.status==200}">
	                                            <c:if test="${item.nodeCode=='RESIGN_COO'}">
	                                                  <li>
                                                ...
                                                <c:if test="${item.nodeCode!='RESIGN_COO' && item.nodeCode!='START'}">
	                                                <li>
							                            <rou></rou>
							                            <div class="r">
							                                <div class="p1"><c:if test="${item.endTime==null}">&nbsp;</c:if><fmt:formatDate value="${item.endTime}"  pattern="yyyy-MM-dd HH:mm"  /></div>
	                                          ...
	                                          <c:if test="${item.status==500 || item.nodeCode=='START'}">
	                                              <li>
                                                     <tab class="blue">提出申请<san></san></tab>
                                                        <div class="r">
                                                           ...
                                                           <div class="p4"><i>申请理由：</i>${business.reason}</div>
                                                        </div>
                                                  </li>
	                                          </c:if>
                        </c:forEach>
