...
<script type="text/javascript" src="<%=basePath%>js/base/addressList/employee_address_list.js?v=20181015"/></script>
</head>


<body class="b-f2f2f2 mt-44">
	<div class="under-kq mail_list">
        <header>
            <h1 class="clearfix"><a href="<%=basePath%>${returnUrl}" class="goback fl"><i class="back sr"></i></a>通讯录<a class="toproblem fr"></a></h1>
        </header>
        ...
        <div class="right-arrow position-bot top-152">
        <div class="main">
        	<ul id="empInfo">
        		<div id="empList"></div>
        	</ul>
	...
	<form id="checkForm" style="display:none" action="" method="post">
