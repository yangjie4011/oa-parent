...
<script type="text/javascript" src="<%=basePath%>js/employeeClass/hr_approve_normal.js?v=20180515"/></script>
</head>
<body class="mt-44">
    <div class="bj-paiban index-kaoqin">
        <header>
            <h1 class="clearfix"><a href="<%=basePath%>employeeClass/query.htm" class="goback fl"><i class="back sr"></i></a>排班审核<a class="toproblem fr"></a></h1>
        </header>
         <div class="new-head">
