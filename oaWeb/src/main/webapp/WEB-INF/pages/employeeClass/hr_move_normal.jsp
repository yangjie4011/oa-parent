...
<script type="text/javascript" src="<%=basePath%>js/employeeClass/hr_move_normal.js?v=20180408"/></script>
</head>
<body class="mt-44">
    <div class="bj-paiban">
        <header>
            <h1 class="clearfix"><a href="<%=basePath%>employeeClass/query.htm" class="goback fl"><i class="back sr"></i></a>编辑排班<a class="toproblem fr"></a></h1>
        </header>
    ...
    <div onclick="moveNormal();" class="foot-btn">
        保存
    </div>
</body>
</html>