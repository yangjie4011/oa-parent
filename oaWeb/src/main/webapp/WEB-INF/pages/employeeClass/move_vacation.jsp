...
<title>编辑值班</title>
<script type="text/javascript" src="<%=basePath%>js/employeeClass/move_vacation.js?v=20180408"/></script>
</head>
<body class="mt-44 b-f2f2f2 mb-50">
    <div>
        <header>
            <h1 class="clearfix"><a href="<%=basePath%>employeeClass/index.htm" class="goback fl"><i class="back sr"></i></a>编辑值班<a id="${duty.id }" onclick="save(this);" class="toproblem fr">提交</a></h1>
        </header>
        <div class="y-silde">
            <ul id="vacationList">
            ...
            <input type="hidden" id="employeeIds" value="${duty.employeeIds }"/>
        </div>
    </div>
    <div class="tab-list">
