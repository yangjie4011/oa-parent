...
<script type="text/javascript" src="<%=basePath%>js/employeeClass/detail.js?v=20180408"/></script>
</head>
<body class="mt-44">
    <div class="bj-paiban">
        <header>
            <h1 class="clearfix"><a <c:if test="${type==2}">href="<%=basePath%>employeeClass/index.htm"</c:if><c:if test="${type==1}">href="<%=basePath%>employeeClass/query.htm"</c:if> class="goback fl"><i class="back sr"></i></a>查看排班<a class="toproblem fr"></a></h1>
        </header>
