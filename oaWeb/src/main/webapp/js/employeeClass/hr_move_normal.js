...
function getClassSetByDepart(){
	$.ajax({
		...
		type:'post',
		dataType:'json',
		url:contextPath + "/classSetting/getListByCondition.htm?departId="+$("#departId").val(),
	...
	OA.twoSurePop({
		...
		sureFn:function(){
		    	...
		    	$.ajax({
		    		...
		    		url:contextPath + "/employeeClass/hrMoveEmployeeClass.htm",
		    		success:function(data){
		    			if(data.success){
							//跳页面
		    				window.location.href=contextPath + "/employeeClass/query.htm";
						}else{
