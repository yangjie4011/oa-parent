$(function(){
	...
	$("#export").click(function(){
		...
		window.location.href = basePath + "workLog/exportWorkLog.htm?"+data;
	})
});
...
function gotoPage(page){
	...
	$.ajax({
		...
		data:data,
		dataType:'json',
		url:contextPath + "/workLog/getWorkLogSearchPage.htm",
	...
	$.ajax({
		...
		success:function(data){
			if(data.success){
                ...
                html += '<div class="col"><div class="buttonDiv button-wrap ml-4"><button onclick="closeProcesInfo();" class="btn-orange btn-large"><span><i class="icon"></i>关闭</span></button></div></div>';
