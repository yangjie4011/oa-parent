...
<body>
	<div class="container">
			...
			<div class="bar">
	            ...
	            <div class="fr">
	                <ul>
	                    ...
	                    <li>
	                    	<a href="<%=basePath%>login/logout.htm" title="退出"><i class="icon exit" title="退出"></i></a>
	                    </li>
	                </ul>
	            </div>
	        </div><!-- bar end -->
	    ...
	    <div class="main clear" id="bottomDiv">
	    	...
	    	<div id="mainDiv">
	    		<iframe src="${pageContext.request.contextPath}/login/toDefault.htm" name="mainFrame" id="mainFrame" height="100%" width="100%" scrolling="yes" frameborder="0"></iframe>	    	
	    	</div>
	    </div>
