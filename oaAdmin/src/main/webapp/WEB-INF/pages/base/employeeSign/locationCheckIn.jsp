...
<script type="text/javascript" src="../js/base/employeeSign/locationCheckIn.js?v=20200318"/></script>
<style type="text/css">
	th,td {
			...
			<div class="title"><strong><i class="icon search1"></i>查询条件</strong><i class="icon arrow-down1"></i></div>
	            ...
	            <input type="hidden" id="pageNo" name="page" value=""/>
	                ...
	                <div class="col">
	                	...
	                	<div class="form">
	                        <label class="w">是否成功：</label>
	                        <select id="delFlag" name="delFlag" class="select_v1">
