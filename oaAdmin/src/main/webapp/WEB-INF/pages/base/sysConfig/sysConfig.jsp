...
<script type="text/javascript" src="../js/base/sysConfig/systemConfig.js?v=20180416"/></script>
<style type="text/css">
	th,td {
	...
	<div class="content" style="overflow-x:auto" id="pageAll">
            ...
            <div>
	            <table>
					 <thead>
						<tr>
			                <th style="overflow-x:auto;width:100px;text-align:center;">编码</th>
			                <th style="overflow-x:auto;width:100px;text-align:center;">描述</th>
			                <th style="overflow-x:auto;width:100px;text-align:center;">页面显示值</th>			                
			                <th style="overflow-x:auto;width:100px;text-align:center;">后台编码</th>
					...
					<div class="form-wrap">
						...
						<div class="form-main">
							...
							<form id="addForm">
								...
								<div class="col">
									<div class="form">
										<label class="w">编码</label><input type="text"
								...
								<div class="col">
									...
									<div class="form">
										<label class="w">页面显示值</label><input type="text"
							...
							<form id="updateForm">
								...
								<div class="col">	
									...
									<div class="form">
										...
										id="delFlag"	class="form-text" name="delFlag" readonly="true">
									</div>
								</div>
