...
<script type="text/javascript" src="../js/base/companyPositionSeq/companyPositionSeq_index.js?v=2018032607"/></script>
<style type="text/css">
	th,td {
            ...
            <div class="form-wrap">
			   <div class="title"><strong><i class="icon search1"></i>操作</strong><i class="icon arrow-down1"  onclick="getButton(this)"></i></div>
                ...
                <div class="form-main">              
	                <div class="col">	               
		                <div class="form">
		                    	<label class="w" style="width:100px;">序列名称</label>
		                    	<input  type="text"  name="name" />							                 
	 					</div>                 	
	                </div>   
	                <div class="col">	               
		                <div class="form">
		                    	<label class="w" style="width:100px;">序列编码</label>
	            ...
	            <table>
					 <thead>
						<tr>
			                ...
			                <th style="overflow-x:auto;width:100px;text-align:center;">序列名称</th>
			                <th style="overflow-x:auto;width:100px;text-align:center;">序列编码</th>			                
		...
		<div class="popbox-center" style="top: 10%; left: 30%">
			<div class="popbox-main" style="">
				<div class="cun-pop-content">
					<div class="form-wrap">
						<div class="title">
							<strong><i class="icon add-user"></i>新增职位序列信息</strong>
						</div>
						...
						<div class="form-main">
							...
							<form id="addForm">
								<div class="col">                    
				                    <div class="form"><label class="w" style="width:100px;">公司名称：</label><select id="companyId" name="companyId" class="select_v1"></select>
				                    </div>
				                </div>							
								<div class="col">
									<div class="form">
										<label class="w">序列名称</label><input type="text"
								...
								<div class="col">
									<div class="form">
										<label class="w">序列编码</label><input type="text"
		...
		<div class="popbox-center" style="top: 10%; left: 30%">
			<div class="popbox-main" style="">
				<div class="cun-pop-content">
					<div class="form-wrap">
						<div class="title">
							<strong><i class="icon add-user"></i>更新职位序列信息</strong>
						</div>
						<div class="form-main">
		...
		<div class="popbox-center" style="top: 10%; left: 30%">
			<div class="popbox-main" style="">
				<div class="cun-pop-content">
					<div class="form-wrap">
						<div class="title">
							<strong><i class="icon"></i>删除当前职位序列？</strong>
						</div>
						<div class="form-main">
							<div class="col">
								<div class="form">
