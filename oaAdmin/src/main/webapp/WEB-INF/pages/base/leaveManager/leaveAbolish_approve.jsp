...
<script type="text/javascript" src="../js/base/leaveManager/leaveAbolish_approve.js?v=20200526"/></script>
<style type="text/css">
	th,td {
   ...
   <div class="datatitle" style="padding-left:0px;">
	...
	<div class="content daiban" style="overflow-x:auto">
            ...
            <div>
                ...
                <button onclick="getBatchApproveDiv();" class="blue-but small"><span><i class="icon"></i>快速审批</span></button>
                <p>&nbsp;</p> <p>&nbsp;</p>
	            ...
	            <table>
					 <thead>
						<tr>
			                ...
			                <th style="overflow-x:auto;width:100px;text-align:center;">假期类型</th>
			                ...
			                <th style="overflow-x:auto;width:150px;text-align:center;">假期时长</th>
			                ...
			                <th style="overflow-x:auto;width:150px;text-align:center;">销假时长</th>
			                <th style="overflow-x:auto;width:150px;text-align:center;">销假申请时间</th>
        ...
        <div class="content yiban" style="overflow-x:auto;display:none;">
            ...
            <!-- 第三个tab -->	
        <div class="content abate" style="overflow-x:auto;display:none;">
               
            <div>
                <button onclick="getBatchApproveAbateDiv();" class="blue-but small"><span><i class="icon"></i>快速审批</span></button>
                <p>&nbsp;</p> <p>&nbsp;</p>

	            <table>
					 <thead>
						<tr>
							<th style="overflow-x:auto;width:100px;text-align:center;"><input type="checkbox" name="selectAllAbate"/></th>
			                <th style="overflow-x:auto;width:100px;text-align:center;">员工编号</th>
			                <th style="overflow-x:auto;width:100px;text-align:center;">员工姓名</th>
			                <th style="overflow-x:auto;width:100px;text-align:center;">部门</th>
			                <th style="overflow-x:auto;width:100px;text-align:center;">假期类型</th>
        ...
        <div class="paging" id="commonPage1" style="display:none;"></div>
        <div class="paging" id="commonPage2" style="display:none;"></div>
	...
	<!-- 快速审批弹框 -->
        <div class="commonBox popbox" id="fastApproveAbateDiv" style="display:none;">
		<div class="popbox-bg"></div>
		<div class="popbox-center" style="top: 0%; left: 30%">
			<div class="popbox-main" style="">
				<div class="cun-pop-content">
					<div class="form-wrap">
						...
						<div class="form-main">
							...
							<form id="fastApproveFormAbate" class="fastApproveForm">
								<div class="col" style="margin-bottom:0px;">
									<div class="form">
										<label class="w"  style="width:130px;">审批处理：</label>
										<input style="width:13px;" type="radio" name="commentType" value="pass" checked="checked"><span style="float:left;">同意</span><span style="float:left;width:20px;">&nbsp;&nbsp;&nbsp;</span><input style="width:13px;" type="radio" name="commentType" value="refuse"><span style="float:left;">拒绝</span>
							...
							<div class="col" style="margin-top:30px;">
								<div class="button-wrap ml-4">
									<button class="red-but" onclick="fastApproveAbate();"  style="width:120px;">
										<span>确定</span>
									</button>
									<button class="small grey-but"
										onclick="closeDiv();" style="width:120px;">
