...
<script type="text/javascript" src="../js/base/leaveManager/leave_approve.js?v=20200526"/></script>
<style type="text/css">
	th,td {
	            ...
	            <table>
					 <thead>
						<tr>
			                ...
			                <th style="overflow-x:auto;width:150px;text-align:center;">开始日期</th>
			                <th style="overflow-x:auto;width:150px;text-align:center;">结束日期</th>
			                <th style="overflow-x:auto;width:150px;text-align:center;">时长</th>
			                <th style="overflow-x:auto;width:150px;text-align:center;">申请时间</th>
