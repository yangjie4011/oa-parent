...
<script type="text/javascript" src="../js/base/attnManager/abnormalAttendanceApprove.js?v=20200525"/></script>
<style type="text/css">
	th,td {
...
<body>
	...
	<div class="datatitle" style="padding-left:0px;">
		<ul class="fl jui-tabswitch" id="parent">
			<li id="listTab" rel="#old" class="active"><strong>异常考勤单审批</strong></li>		
			<li id="detailTab" rel="#new"><strong>下属异常考勤单审批</strong></li>
		</ul>
	</div>
	<div class="datatitle son" style="padding-left:0px;">
		<ul class="fl jui-tabswitch sonList">
			<li id="listTabs" class="active" onclick="sonList(null,0)">待办</strong></li>
			<li id="detailTabs" onclick="sonList(null,1)">已办</strong></li>
			<li id="overDueTabs" onclick="sonList(null,2)">失效</strong></li>
		</ul>	
	</div>			
	...
	<div class="content first" style="overflow-x:auto">
               ...
               <input type="hidden" name="applyType" value="0"/>              
                ...
                <div class="col">
                    <div class="form">
                        ...
                        <select  name="workType" class="select_v1 workType">
                        </select>
                    </div>
                    
                    <div class="form">
                        <label class="w" style="width:100px;">部门：</label>
                        <select  name="firstDepart" class="select_v1 firstDepart">
                        </select>
                    </div>
                </div>
                <div class="col">
	                <div class="form">
	                    	<label class="w" style="width:100px;">考勤日期：</label>
            ...
            <div>
            	<button onclick="getBatchApproveDiv(1);" class="blue-but small"><span><i class="icon"></i>快速审批</span></button>
                <p>&nbsp;</p> <p>&nbsp;</p>
	            <table>
					 <thead>
						<tr>
							<th style="overflow-x:auto;width:100px;text-align:center;"><input type="checkbox" name="selectAll"/></th>
			                ...
			                <th style="overflow-x:auto;width:100px;text-align:center;">原打卡时间</th>
			                <th style="overflow-x:auto;width:150px;text-align:center;">申诉上班时间</th>
			                <th style="overflow-x:auto;width:100px;text-align:center;">申诉下班时间</th>
    	...
    	<div class="content second" style="overflow-x:auto;display:none;">
            ...
            <div class="form-wrap">
              ...
              <div class="col">  
                    <div class="button-wrap ml-4">
                        <button id="query2" class="red-but"><span><i class="icon search"></i>查询</span></button> 
                    </div> 
                </div> 
			</div>
            <div>
        ...
        <div class="paging" id="commonPage2"></div>   
        
        <!-- 失效异常考勤 -->
        <div class="content five" style="overflow-x:auto;display:none;">
            <div class="form-wrap">
			   <div class="title"><strong><i class="icon search1"></i>查询条件</strong><i class="icon arrow-down1" onclick="getButton(this)"></i></div>
               <input type="hidden" id="currentCompanyId" value="${requestScope.companyId }"/>
               <form id="queryform5">
              ...
              <div class="col">  
                    <div class="button-wrap ml-4">
                        <button id="query5" class="red-but"><span><i class="icon search"></i>查询</span></button> 
                    </div> 
                </div> 
			</div>
            <div>
	            <table>
					 <thead>
		              ...
		              <tbody id="reportList5">
		              </tbody>
	            </table>
            </div>           
        </div>
        <div class="paging" id="commonPage5"></div>  
        
        <!-- 失效异常考勤 -->
        
    <!-- 下属异常考勤 -->  	
   <div class="content third" style="overflow-x:auto;display:none;">
            ...
            <div class="form-wrap">
              ...
              <div class="col">  
                    <div class="button-wrap ml-4">
                        <button id="query3" class="red-but"><span><i class="icon search"></i>查询</span></button> 
                    </div> 
                </div> 
			</div>
            <div>
          		<button onclick="getBatchApproveDiv(2);" class="blue-but small"><span><i class="icon"></i>快速审批</span></button>
                <p>&nbsp;</p> <p>&nbsp;</p>
	            <table>
					 <thead>
						<tr>
							<th style="overflow-x:auto;width:100px;text-align:center;"><input type="checkbox" name="selectAll1"/></th>																				
							<th style="overflow-x:auto;width:100px;text-align:center;">员工编号</th>
			                <th style="overflow-x:auto;width:100px;text-align:center;">员工姓名</th>
			                <th style="overflow-x:auto;width:100px;text-align:center;">部门</th>
			                <th style="overflow-x:auto;width:100px;text-align:center;">工时制</th>
			                ...
			                <th style="overflow-x:auto;width:100px;text-align:center;">异常考勤日期</th>
			                <th style="overflow-x:auto;width:150px;text-align:center;">原打卡时间</th>
			                <th style="overflow-x:auto;width:150px;text-align:center;">申诉上班时间</th>
			                <th style="overflow-x:auto;width:100px;text-align:center;">申诉下班时间</th>
			                <th style="overflow-x:auto;width:100px;text-align:center;">申诉理由</th>	                
			                <th style="overflow-x:auto;width:100px;text-align:center;">操作</th>
		              ...
		              <tbody id="reportList3">
		              </tbody>
	            </table>
            </div>           
        </div>
      	<div class="paging" id="commonPage3"></div>   	
  
  <!-- 下属异常考勤 已办 --> 
      <!-- 下属异常考勤 -->  	
   <div class="content fourth" style="overflow-x:auto;display:none;">
            ...
            <div class="form-wrap">
              ...
              <div class="col">  
                    <div class="button-wrap ml-4">
                        <button id="query4" class="red-but"><span><i class="icon search"></i>查询</span></button> 
                    </div> 
                </div> 
			</div>
            <div>
	            <table>
					 <thead>
		              ...
		              <tbody id="reportList4">
		              </tbody>
	            </table>
            </div>           
        </div>
      	<div class="paging" id="commonPage4"></div>   
      	
      	
    <!-- 失效下属异常考勤 -->  	
   <div class="content six" style="overflow-x:auto;display:none;">
            ...
            <div class="form-wrap">
               ...
               <input type="hidden" name="applyType" value="1"/>
                ...
                <div class="col">
                    ...
                    <div class="form">
                  	...
                  	<div class="form">
                    	<label class="w" style="width:100px;">申诉主管：</label>
                    	<input type="text" class="form-text" name=agentName value="">
                    </div>  
              ...
              <div class="col">  
                    <div class="button-wrap ml-4">
                        <button id="query6" class="red-but"><span><i class="icon search"></i>查询</span></button> 
                    </div> 
                </div> 
			</div>
            <div>
	            <table>
					 <thead>
		              ...
		              <tbody id="reportList6">
		              </tbody>
	            </table>
            </div>           
        </div>
      	<div class="paging" id="commonPage6"></div>     	
      	<!-- 失效下属异常考勤 -->  	
