...
<script type="text/javascript" src="../js/base/business/businessApprove.js?v=20200526"/></script>
<style type="text/css">
	th,td {
...
<body>
	<div class="datatitle son" id="son" style="padding-left:0px;">
		<ul class="fl jui-tabswitch">
			...
			<li id="shixiaoTab" rel="#new"><strong>失效</strong></li>
		</ul>
	</div>
	<div class="form-wrap">
	...
	<div class="content daiban" style="overflow-x:auto">
            <button onclick="getBatchApproveDiv();" class="showApproveDiv blue-but small" style="margin-bottom:5px;"><span><i class="icon"></i>快速审批</span></button>
	            <table>
					 <thead>
						<tr>
			            	...
			            	<th style="overflow-x:auto;width:150px;text-align:center;">工时制</th>
			                ...
			                <th style="overflow-x:auto;width:150px;text-align:center;">出差天数</th>
			                <th style="overflow-x:auto;width:150px;text-align:center;">出差地点</th>
			                <th style="overflow-x:auto;width:150px;text-align:center;">交通工具 </th>
			                <th style="overflow-x:auto;width:150px;text-align:center;">出差事由</th>
    ...
    <!-- 详情弹框 -->
     <div class="artical-box-bg" style="display:none;">
        <div class="artical-box" style="height: 500px;">
            <h2>假期详情</h2>
